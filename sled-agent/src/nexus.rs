    ...
    for sled_hardware_types::CpuFamily
{
    fn convert(self) -> nexus_client::types::SledCpuFamily {
        match self {
            ...
            sled_hardware_types::CpuFamily::AmdFamily19h => {
                nexus_client::types::SledCpuFamily::AmdFamily19h
            }
            sled_hardware_types::CpuFamily::AmdFamily1Ah => {
                nexus_client::types::SledCpuFamily::AmdFamily1Ah
            }
        }
    }
}
